...
public class furniture_category_save extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_furniture_category_save, container, false);
        recyclerView = v.findViewById(R.id.recycleviewhome_funi_save);
    ...
    public void onCreate(@Nullable Bundle saveInstaceState){
        ...
        mlist = new ArrayList<>();
        mlist = DataApps.getInstance().saveFurniture;
    }
