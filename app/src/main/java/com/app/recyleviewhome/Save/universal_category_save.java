...
public class universal_category_save extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_universal_category_save, container, false);
        recyclerView = v.findViewById(R.id.recycleviewhome_universal_save);
    ...
    public void onCreate(@Nullable Bundle saveInstaceState){
        ...
        mlist = new ArrayList<>();
        mlist = DataApps.getInstance().save;
    }
